        ...
        try:
            ...
            for convo in conversations:
                ...
                convo_data = {
                    ...
                    'useOverrides': overrides.get('useOverrides', 0),
                    'overrideSubtitleSettings': self._parse_bool(overrides.get('overrideSubtitleSettings')),
                    'showNPCSubtitlesDuringLine': self._parse_bool(overrides.get('showNPCSubtitlesDuringLine')),
                    'showNPCSubtitlesWithResponses': self._parse_bool(overrides.get('showNPCSubtitlesWithResponses')),
                    'showPCSubtitlesDuringLine': self._parse_bool(overrides.get('showPCSubtitlesDuringLine')),
                    'skipPCSubtitleAfterResponseMenu': self._parse_bool(overrides.get('skipPCSubtitleAfterResponseMenu')),
                    'subtitleCharsPerSecond': self._parse_number(overrides.get('subtitleCharsPerSecond')),
                    'minSubtitleSeconds': self._parse_number(overrides.get('minSubtitleSeconds')),
                    'continueButton': self._parse_bool(overrides.get('continueButton')),
                    'overrideSequenceSettings': self._parse_bool(overrides.get('overrideSequenceSettings')),
                    'defaultSequence': overrides.get('defaultSequence'),
                    'defaultPlayerSequence': overrides.get('defaultPlayerSequence'),
                    'defaultResponseMenuSequence': overrides.get('defaultResponseMenuSequence'),
                    'overrideInputSettings': overrides.get('overrideInputSettings', 0),
                    'alwaysForceResponseMenu': overrides.get('alwaysForceResponseMenu', 0),
                    'includeInvalidEntries': overrides.get('includeInvalidEntries', 0),
                    'responseTimeout': self._parse_number(overrides.get('responseTimeout')),
                    'nodeColor': convo.get('nodeColor'),
                    'canvasScrollPositionX': self._parse_number(convo.get('canvasScrollPosition', {}).get('x')),
                    'canvasScrollPositionY': self._parse_number(convo.get('canvasScrollPosition', {}).get('y')),
                    'canvasZoom': self._parse_number(convo.get('canvasZoom')),
